        ...
        <div class="col-sm-6">
          <div class="a-section">
            ...
            <h2 style="text-align: center">
              Modifier le produit: {{ product.title }}
            </h2>
            <form>
              <!-- Category Dropdown -->
              ...
              <!-- Title input -->
              <div class="a-spacing-top-medium">
                <label style="margin-bottom: 0px;">Titre</label>
                <input
                  type="text"
                  class="a-input-text"
                  style="width: 100%"
              ...
              <!-- StockQuantity input -->
              <div class="a-spacing-top-medium">
                <label style="margin-bottom: 0px;">Quantité du stock</label>
                <input
                  type="number"
                  class="a-input-text"
                  style="width: 100%"
              ...
              <div class="a-spacing-top-medium">
                <label style="margin-bottom: 0px;">Déscription</label>
                <textarea
                  style="width: 100%"
                  v-model="description"
