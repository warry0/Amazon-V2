  ...
  <main>
    ...
    <div class="container-fluid" >
      <div class="dp-container">
        <div class="row">
          <!-- Première grille 3 - Image du produit et section auteur -->
          <div class="col-lg-3 col-md-3 col-sm-4">
            <div class="leftCol">
              ...
              <div class="authorFollow">
                ...
                <h1 class="authorFollowHeading">Suivez l'auteur</h1>
            ...
            <div class="centerCol">
              ...
              <div class="titleDiv">
                <h1 class="productTitle">
                  ...
                  <span class="smallTitle">Livres de poche</span>
                </h1>
              </div>
              <!-- Nom de l'auteur -->
                ...
                <div class="formats">
                  <a href="#" class="link-expander">
                    ...
                    <span class="tmmShowPrompt"
                      >Voir les autres formats et éditions</span
                    >
                  </a>
                  <ul>
                    <!-- Kindle -->
                  ...
                  <div class="clearfix">
                    <div class="float-left">
                      <form>
                        ...
                        />
                        <label for="test1">Acheter maintenant</label>
                      </form>
                    </div>
                  ...
                  <div class="a-button-stack">
                    ...
                    >
                      <span class="a-button-inner">
                        ...
                        />
                        <span class="a-button-text">Ajouter au panier</span>
                      </span>
                    </span>
                  </div>
                  <div class="a-button-stack">
                    ...
                    >
                      <span class="a-button-inner">
                        ...
                        <input
                          ...
                          class="a-button-input"
                        />
                        <span class="a-button-text">Acheter maintenant</span>
                      </span>
                    </span>
                  </div>
                </div>
                  ...
                  <div class="a-spacing-top-small">
                    <div class="a-section a-spacing-none">
                      <div class="a-section a-spacing-none a-spacing-top-mini">
                        Cet article est expédié à
                        <b>Massy</b>
                        <b
                          >Recevez-le d'ici lundi 23 septembre - lundi 30
                          septembre</b
                        >
                        Choisissez cette date lors du paiement
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <span class="a-declarative">
                  <a href="#" class="a-link-normal">
                    <div class="a-row a-spacing-mini">
                      ...
                      <span class="a-size-small">Livrer en France</span>
                    </div>
                  </a>
                </span>
                <br />
                  ...
                  <div class="authorContent">
                    ...
                    <div class="authorFollow">
                      <button class="followButton" type="button">
                        ...
                        <span class="pr-fb-text">Suivre</span>
                      </button>
                    </div>
                  </div>
                </div>
